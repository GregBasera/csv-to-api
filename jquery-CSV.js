  ...
  function () {
    ...
    ((p = "undefined" != typeof jQuery && jQuery ? jQuery : {}).csv = {
      ...
      parsers: {
        parse: function (r, e) {
          ...
          var o = [],
            ...
            l = !1;
          function u() {
            if (((n = 0), (i = ""), e.start && e.state.rowNum < e.start)) return (s = []), e.state.rowNum++, void (e.state.colNum = 1);
              ...
              if (!l)
                switch (n) {
                  ...
                  case 3:
                    ...
                    if (r === t) throw Error("CSVDataError: Illegal Quote [Row:" + e.state.rowNum + "][Col:" + e.state.colNum + "]");
      ...
      helpers: {
        collectPropertyNames: function (r) {
          var e = [],
            a = [],
            t = [];
          for (e in r) for (a in r[e]) r[e].hasOwnProperty(a) && t.indexOf(a) < 0 && "function" != typeof r[e][a] && t.push(a);
          return t;
        },
      },
      toArray: function (r, e, a) {
        ...
        e = { delimiter: t.delimiter, separator: t.separator, onParseEntry: e.onParseEntry, onParseValue: e.onParseValue, state: o };
      ...
      toObjects: function (r, e, a) {
        ...
        var n = { delimiter: t.delimiter, separator: t.separator, start: 1, end: 1, state: { rowNum: 1, colNum: 1 }, headers: !0 };
      ...
      fromArrays: function (r, e, a) {
        ...
        for (n = 0; n < r.length; n++) {
          for (o = r[n], s = [], i = 0; i < o.length; i++) {
            ...
            var c = "\n|\r|S|D";
            (c = (c = c.replace("S", t.separator)).replace("D", t.delimiter)), -1 < u.search(c) && (u = t.delimiter + u + t.delimiter), s.push(u);
          }
      ...
      fromObjects: function (r, e, a) {
        ...
        for (t.headers && d.push(l), n = 0; n < r.length; n++) {
          for (i = [], u = 0; u < l.length; u++) (f = l[u]) in r[n] && "function" != typeof r[n][f] ? i.push(r[n][f]) : i.push("");
          d.push(i);
        }
